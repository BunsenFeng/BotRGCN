...
class GATClassifier(pl.LightningModule):
    def __init__(self, in_channels, out_channels, dropout, label_user_count, batch_size):
        ...
        self.linearP = nn.Linear(6, int(out_channels / 2))
    ...
    def forward(self, x): 
        ...
        property_features = x[4].squeeze(0)
    ...
    def training_step(self, train_batch, batch_idx):
        ...
        property_features = train_batch[4].squeeze(0)
    ...
    def validation_step(self, val_batch, batch_idx):
        ...
        property_features = val_batch[4].squeeze(0)
