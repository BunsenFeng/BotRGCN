...
from torch_geometric.nn import MessagePassing, RGCNConv, GATConv, GCNConv
...
class GATClassifier(pl.LightningModule):
    def __init__(self, in_channels, out_channels, dropout, label_user_count, batch_size):
        ...
        self.linearS1 = nn.Linear(768, int(out_channels / 4))
        self.linearS2 = nn.Linear(768, int(out_channels / 4))
        ...
        #self.GCN1 = GCNConv(in_channels=out_channels, out_channels=out_channels)
    ...
    def forward(self, x): 
        ...
        #node_features = self.dropout_layer(self.relu(self.GCN1(node_features, edge_index)))
        #node_features = self.dropout_layer(self.relu(self.GCN1(node_features, edge_index)))
    ...
    def validation_step(self, val_batch, batch_idx):
        ...
        #node_features = self.relu(self.GCN1(node_features, edge_index))
        #node_features = self.relu(self.GCN1(node_features, edge_index))
